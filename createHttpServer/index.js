...
exports.default = (options, hostport, routes, onServerRun) => {
    ...
    process.on('SIGTERM', () => {
        console.log("SIGTERM");
        (0, terminateHttp_1.default)(server, 0);
    });
    process.on('SIGINT', () => {
        console.log("SIGINT");
        (0, terminateHttp_1.default)(server, 0);
